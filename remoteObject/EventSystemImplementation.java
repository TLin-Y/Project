...
public class EventSystemImplementation extends EventSystemInterfacePOA  {
 ...
 */
	public EventSystemImplementation(String city,ORB orb ){
	 ...
	 */
	public Any listEventAvailabilityOnServer(String managerId, String eventtype){
	...
	public synchronized Any bookevent(String customerId, String eventId, String eventtype)
		...
		Any any = getbookingSchedule(customerId);
		HashMap<String, ArrayList<String>> bookingSchedule = (HashMap<String, ArrayList<String>>) any.extract_Value();
	...
	public Any swapEvent(String customerId,  String neweventId, String neweventtype, String oldeventId, String oldeventtyped) {
		boolean status = true;
		String msg = null;
		...
		//Step6： drop old event
				result1 = dropevent(customerId, oldeventId);
				result2 = (SimpleEntry<Boolean, String>) result1.extract_Value();
				
				if (result2.getKey()) {//Drop old event good.
					//Step7: enroll in new event
					Any any2 = bookevent(customerId, neweventId, neweventtype);
					result2 = (SimpleEntry<Boolean, String>) any2.extract_Value();
	...
	private SimpleEntry<Boolean, String> atomicSwapOnThisServer(String customerId, String neweventId,
		...
		try {
			...
			// get customer schedule
			Any any3 = getbookingSchedule(customerId);
			HashMap<String, ArrayList<String>> bookingSchedule = (HashMap<String, ArrayList<String>>) any3.extract_Value();
			List<String> cityEvents = new ArrayList<>();
			List<String> outOfcityEvents = new ArrayList<>();
			LinkedList<Integer> difCitySameMonth = new LinkedList<Integer>();
			int f,max=0;
			...
			//System.out.println("On newevent city's server, find newevent is available!");
				...
				Any any = dropevent(customerId, oldeventId);
				...
				if (result.getKey()) {
					Any any2 = bookevent(customerId, neweventId, newEventype);
					result = (SimpleEntry<Boolean, String>) any2.extract_Value();
